...
resource "aws_appsync_resolver" "this" {
  ...
  # For VTL, use request/response_template; for JS, these will be null
  request_template  = try(each.value.runtime.name == "APPSYNC_JS", false) ? null : lookup(each.value, "request_template", "{}")
  response_template = try(each.value.runtime.name == "APPSYNC_JS", false) ? null : lookup(each.value, "response_template", "{}")
